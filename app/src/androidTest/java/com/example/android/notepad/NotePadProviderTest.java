...
@SmallTest
public class NotePadProviderTest {
    ...
    private NotePadProvider mProvider;
    ...
    public void setUp() {
        ...
        providerInfo.authority = NotePad.AUTHORITY;
        mProvider.attachInfo(mContext, providerInfo);

        /*
         * Gets a handle to the database underlying the provider.
         * Note: The new NotesProvider uses NoteDbHelper instead of DatabaseHelper
         */
        NoteDbHelper dbHelper = new NoteDbHelper(mContext);
        mDb = dbHelper.getWritableDatabase();

        // Clear the database before each test
        mDb.delete(NotePad.Notes.TABLE_NAME, null, null);
    }
    ...
    public void testUriAndGetType() {
        ...
        String mimeType = mProvider.getType(NotePad.Notes.CONTENT_URI);
        ...
        mimeType = mProvider.getType(noteIdUri);
        assertEquals(NotePad.Notes.CONTENT_ITEM_TYPE, mimeType);

        // Tests an invalid URI. This should throw an IllegalArgumentException.
        try {
            mProvider.getType(INVALID_URI);
            fail("Should have thrown IllegalArgumentException for invalid URI");
    ...
    public void testQueriesOnNotesUri() {
        ...
        Cursor projectionCursor = mProvider.query(
                NotePad.Notes.CONTENT_URI,  // the URI for the main data table
        ...
        projectionCursor = mProvider.query(
                NotePad.Notes.CONTENT_URI, // the URI for the main data table
                TEST_PROJECTION,           // get the title, note, and mod date columns
    ...
    public void testQueriesOnNoteIdUri() {
        ...
        cursor = mProvider.query(noteIdUri, // the URI for a single note
    ...
    public void testInserts() {
        ...
        int timestampIndex = cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TIMESTAMP);
        ...
        // Check that timestamp was automatically set (should not be null or empty)
        assertNotNull(cursor.getString(timestampIndex));
        assertFalse(cursor.getString(timestampIndex).isEmpty());
        ...
        try {
            mProvider.insert(NotePad.Notes.CONTENT_URI, values);
    ...
    public void testDeletes() {
        ...
        int rowsDeleted = mProvider.delete(
    ...
    public void testUpdates() {
        ...
        int rowsUpdated = mProvider.update(
        ...
        Cursor cursor = mProvider.query(
                ...
                new String[]{NotePad.Notes.COLUMN_NAME_TIMESTAMP},
                SELECTION_COLUMNS,
                selectionArgs,
                null
        );
    ...
    private static class NoteInfo {
        ...
        public ContentValues getContentValues() {
            ...
            // Note: timestamp will be automatically set by the provider
            return v;
        }
    }
}